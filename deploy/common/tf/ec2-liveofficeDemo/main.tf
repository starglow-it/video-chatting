terraform {
  backend "s3" {
    ...
    key     = "ec2-liveofficeDemo.terraformstate"
...
resource "aws_security_group" "sg" {
  name = "liveofficeDemo-sg"
  description = "sg for liveofficeDemo ec2"
...
hostname "liveofficeDemo"
echo "liveofficeDemo" > /etc/hostname
EOF
