...
export const connectStripeAccountFx = paymentsDomain.effect<any, { url: string } | undefined, any>(
    'connectStripeAccount',
);
export const loginStripeAccountFx = paymentsDomain.effect<any, { url: string } | undefined, any>(
