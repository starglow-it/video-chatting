...
import {CountryStatistic, CountryStatisticDocument} from "../../schemas/country-statistic.schema";
...
export class CountryStatisticsService {
    ...
    async create({ data, session }: { data: ICountryStatistic, session: ITransactionSession }) {
