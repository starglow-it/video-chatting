...
const ConfirmCreateRoomDialog = memo(
	({
		onCreate,
	}: {
        onCreate: (data: { isNeedToPublish: boolean }) => void;
    }) => {
		const confirmCreateAndPublishDialog = useStore(
			$confirmCreateAndPublishRoomDialogStore,
		);
...
ConfirmCreateRoomDialog.displayName = 'ConfirmCreateRoomDialog';

export { ConfirmCreateRoomDialog };
