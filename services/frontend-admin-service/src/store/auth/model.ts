...
export const $authStore =
    authDomain.createStore<AuthAdminState>(initialAuthState);

export const loginAdminFx = authDomain.createEffect<
    LoginAdminPayload,
    AuthAdminState
>('loginAdminFx');
export const checkAdminAuthFx = authDomain.createEffect<
    NextPageContext,
    AuthAdminState
>('checkAdminAuthFx');
