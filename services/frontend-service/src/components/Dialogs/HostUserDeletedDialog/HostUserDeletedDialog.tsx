...
// components
import {CustomTypography, CustomButton, CustomDialog, CustomGrid, WarningIcon} from "shared-frontend";
...
const Component = () => {
    ...
    const { hostUserDeletedDialog } = useStore($appDialogsStore);
    ...
    return (
        ...
        >
            <CustomGrid container alignItems="center" direction="column">
                ...
                <CustomTypography
                    textAlign="center"
                    label={<Translation nameSpace="meeting" translation="hostDeleted.text" />}
                />
