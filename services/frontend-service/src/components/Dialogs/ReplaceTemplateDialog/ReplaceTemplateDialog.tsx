...
import {
	TemplatesGrid 
} from '@components/Templates/TemplatesGrid/TemplatesGrid';
import {
	ReplaceTemplateItem 
} from '@components/Templates/ReplaceTemplateItem/ReplaceTemplateItem';

// stores
import {
	EntityList, ICommonTemplate, IUserTemplate 
} from 'shared-types';
import {
	Translation 
