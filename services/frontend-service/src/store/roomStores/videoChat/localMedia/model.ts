...
export const $audioDevicesStore = videoChatDomain.createStore<UseMediaDevices['audioDevices']>([]);
export const $videoDevicesStore = videoChatDomain.createStore<UseMediaDevices['videoDevices']>([]);
export const $activeStreamStore = videoChatDomain.createStore<CustomMediaStream>(null);
export const $changeStreamStore = videoChatDomain.createStore<CustomMediaStream>(null);
export const $isCameraActiveStore = videoChatDomain.createStore<boolean>(false);
export const $isMicActiveStore = videoChatDomain.createStore<boolean>(true);
export const $isStreamRequestedStore = videoChatDomain.createStore<boolean>(false);
...
export const $sharingStream = videoChatDomain.createStore<CustomMediaStream>(null);
...
export const setAudioDevicesEvent =
    videoChatDomain.createEvent<UseMediaDevices['audioDevices']>('setAudioDevicesEvent');
export const setVideoDevicesEvent =
    videoChatDomain.createEvent<UseMediaDevices['videoDevices']>('setAudioDevicesEvent');
...
export const setIsCameraActiveEvent =
    videoChatDomain.createEvent<boolean>('setIsCameraActiveEvent');
export const setIsAudioActiveEvent = videoChatDomain.createEvent<boolean>('setIsAudioActiveEvent');
...
export const setActivePermissionsEvent = videoChatDomain.createEvent<SetActivePermissionsPayload>(
    'setActivePermissionsEvent',
);
export const setAudioErrorEvent = videoChatDomain.createEvent<string | undefined>(
    'setAudioErrorEvent',
);
export const setVideoErrorEvent = videoChatDomain.createEvent<string | undefined>(
    'setVideoErrorEvent',
);
...
export const setIsAuraActive = videoChatDomain.createEvent<boolean>('setIsAuraActive');
export const toggleIsAuraActive = videoChatDomain.createEvent<void>('toggleIsAuraActive');
export const resetMediaStoreEvent = videoChatDomain.createEvent('resetMediaStoreEvent');
...
export const initDevicesEventFx = videoChatDomain.createEffect<InitDevicesPayload, void>(
    'initDevicesEvent',
);
export const changeStreamFx = videoChatDomain.createEffect<ChangeStreamPayload, void>(
    'changeStreamFx',
);
export const chooseSharingStreamFx = videoChatDomain.createEffect<void, CustomMediaStream>(
