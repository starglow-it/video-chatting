...
export class AudiencesGateway extends BaseGateway {
  constructor(
  ...
  @WsEvent(UsersSubscribeEvents.OnRequestRoleByAudience)
  async requestSwitchRoleByAudience(
    ...
    return withTransaction(
      ...
      async (session) => {
        ...
        return await this.sendSwtichRoleRequest({
          meetingUser,
          meeting,
          emitterEvent: UserEmitEvents.RequestSwitchRoleByAudience,
  ...
  @WsEvent(UsersSubscribeEvents.OnAnswerRequestByAudience)
  async answerSwitchRoleByAudience(
    @ConnectedSocket() socket: Socket,
    ...
    return withTransaction(
      ...
      async (session) => {
        ...
        return await this.answerSwitchRoleRequest({
          ...
          meetingUser: userUpdated,
          action,
          emitterEvent: UserEmitEvents.AnswerSwitchRoleByAudience,
          socketEmitterId: host.socketId,
        });
      },
      {
