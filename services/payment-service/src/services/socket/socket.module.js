        ...
        (0, common_1.Module)({
            imports: [
                microservices_1.ClientsModule.registerAsync([
                    {
                        name: shared_const_1.SOCKET_PROVIDER,
                        ...
                        useFactory: function (config) { return __awaiter(void 0, void 0, void 0, function () {
                            var _a, rabbitMqUser, rabbitMqPass, rabbitMqHost, rabbitMqSocketQueue;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, config.getAll()];
                                    case 1:
                                        _a = _b.sent(), rabbitMqUser = _a.rabbitMqUser, rabbitMqPass = _a.rabbitMqPass, rabbitMqHost = _a.rabbitMqHost, rabbitMqSocketQueue = _a.rabbitMqSocketQueue;
                                        return [2 /*return*/, {
                                                transport: microservices_1.Transport.RMQ,
                                                options: {
                                                    urls: ["amqp://".concat(rabbitMqUser, ":").concat(rabbitMqPass, "@").concat(rabbitMqHost)],
